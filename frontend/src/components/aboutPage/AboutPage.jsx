    ...
    <div className="about-page">
      ...
      <div className="team-story">
        ...
        <p>
          ...
          There was Erika, the coding prodigy, who could turn lines of code into magic; Carmelle, the organizational wizard, who had a knack for creating efficient workflows; 
