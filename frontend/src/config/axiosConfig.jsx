...
axios.defaults.baseURL =
  window.location.hostname === "localhost"
    ? "https://52.221.193.216:4000/" // Development (local)
    : "https://52.221.193.216:4000/"; // Production (use the same base URL)
...
export const imageBaseURL =
  window.location.hostname === "localhost"
    ? "https://52.221.193.216:4000" // Development (local)
    : "https://52.221.193.216:4000"; // Production (same image base URL)
